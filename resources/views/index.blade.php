    ...
    <div class="row">
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-danger card-img-holder text-white">
                <div class="card-body">
                    <img src="{{ asset('admin/dist/assets/images/dashboard/circle.svg') }}" class="card-img-absolute"
                        alt="circle-image" />
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ asset('admin/dist/assets/images/faces/face1.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('admin/dist/assets/images/faces/face2.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('admin/dist/assets/images/faces/face3.jpg') }}"
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('admin/dist/assets/images/faces/face4.jpg') }}"
